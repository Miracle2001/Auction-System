...
<div class="container mt-2">
    <div class="row">
        <div class="col-md-6 mt-5">
            <div class="card mt-6" style="background-color:#6E806E;">
                <div class="card-header text-center">
                    <h3> <a class="active text-white" href="buyerregistration.php" >Buyer</a></h3>
                </div>
            </div>
        ...
        <div class="col-md-6 mt-5" >
            <div class="card mt-6" style="background-color:#6E806E;">
                <div class="card-header text-center">
                    <h3 class="seller-header"><a class="text-white" href="sellerregistration.php" style="text-decoration:none;">Seller</a></h3>
                </div>
            </div>
            ...
            <div class ="col-md-12 mt-2">
                <div class="card">
                    <div class="card-body row">
                        ...
                        <div class="col-12 mt-2">
                            <h6> Have an account! <a href="buyerlogin.php" style="text-decoration:none;">Login</a></h6>
                        </div>
