                ...
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="buyerregistration.php">Buyer</a></li>
                            <li><a class="dropdown-item" href="sellerregistration.php">Seller</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <li><a class="dropdown-item" href="buyerlogin.php">Buyer</a></li>
                            <li><a class="dropdown-item" href="sellerlogin.php">Seller</a></li>
