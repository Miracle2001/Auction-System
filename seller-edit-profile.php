...
<div class="container">
    <div class="row">
        ...
        <form action="seller-edit-profile-code.php" method="POST" enctype="multipart/form-data" class="row g-3 needs-validation">
            <?php
            ...
            <div class ="col-md-12 mt-2">
                <div class="card">
                    ...
                    <div class="col-12 mt-2 px-2">
                        <button name="updateprofile" style="background-color:#6E806E;" type="submit" class="btn text-white">Update Profile</button>
                    </div>
