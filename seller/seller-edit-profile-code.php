...
if(isset($_POST['updateprofile'])){
    ...
    if(mysqli_num_rows($check_email_query_run) > 0){
        ...
        if($pass_decode){
            ...
            $update_token = "UPDATE seller SET first_name='$first_name', last_name='$last_name', student_id='$student_id', email_address='$email_address', password='$new_password_encryption' WHERE seller_id='$current_user' LIMIT 1";
