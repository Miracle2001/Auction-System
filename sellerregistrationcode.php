...
if(isset($_POST['submit'])){
    ...
    if(mysqli_num_rows($check_email_query_run) > 0){
        ...
        $query = "INSERT INTO seller (first_name, last_name, student_id, email_address, password, street_address, county, city, eircode, verify_token) VALUES ('{$first_name}', '{$last_name}', '{$student_id}', '{$email_address}', '{$password_encryption}', '{$street_address}', '{$county}', '{$city}', '{$eircode}', '{$verify_token}')";
