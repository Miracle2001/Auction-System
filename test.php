...
<!-- banner -->
	<div class="container-fluid">
		...
		?>	
			...
			<?php
			$sqlproduct = "select * from stock WHERE status='Active' AND category_id='$rscategory[category_id]' ";
...
<script type="application/javascript">countdowntimer('<?php echo $rsproduct[0]; ?>', '<?php echo date("M d, Y H:i:s",strtotime($rsproduct['auction_date_end'])); ?>');</script>
